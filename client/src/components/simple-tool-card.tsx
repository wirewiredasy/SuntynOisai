...
export default function SimpleToolCard({ 
  ...
  return (
    <Link href={`/tool/${slug}`}>
      <div className="group bg-white border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-md transition-all duration-200 cursor-pointer hover:-translate-y-1">
